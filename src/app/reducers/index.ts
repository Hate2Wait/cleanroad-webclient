...
import * as fromAuth from '@cleanroad/core/reducers/auth.reducer';
import * as fromLayout from '@cleanroad/core/reducers/layout.reducer';
import * as fromTitle from '@cleanroad/core/reducers/title.reducer';
